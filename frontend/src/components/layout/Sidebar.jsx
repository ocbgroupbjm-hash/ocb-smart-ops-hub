  ...
  const menuStructure = [
    ...
    // ============================================================
    {
      ...
      submenu: [
        ...
        { name: 'Barcode Advanced', icon: QrCode, path: '/master/barcode-advanced' },
        { divider: true, label: 'Promosi & Diskon' },
        { name: 'Diskon Periode', icon: Percent, path: '/master/discounts' },
        { name: 'Diskon Advanced', icon: Percent, path: '/master/discounts-advanced' },
        { name: 'Periode Promosi', icon: Calendar, path: '/master/promotions' },
        { name: 'Promosi Advanced', icon: Calendar, path: '/master/promotions-advanced' },
        ...
        { name: 'Pelanggan Advanced', icon: Users, path: '/master/customers-advanced' },
