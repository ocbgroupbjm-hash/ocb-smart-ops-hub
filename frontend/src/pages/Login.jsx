...
import { Loader2, Eye, EyeOff, Sparkles, Brain, BarChart3, ShoppingCart } from 'lucide-react';
        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="flex items-center gap-4 p-4 bg-red-900/20 border border-red-700/30 rounded-xl">
              ...
              <div>
                <div className="font-semibold text-amber-100">AI Business Analytics</div>
                <div className="text-sm text-gray-400">Insight penjualan, restock, performa</div>
              </div>
            </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#1a1214] border border-red-900/30 rounded-xl p-8 shadow-xl">
            ...
            <p className="text-gray-400 mb-6">
              {isLogin ? 'Masuk ke sistem OCB AI TITAN' : 'Buat akun baru untuk mengakses sistem'}
            </p>
            ...
            {isLogin && (
              <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700/30 rounded-lg">
                ...
                <div className="text-sm text-gray-300">admin@ocb.com / admin123</div>
              </div>
            )}
          </div>
